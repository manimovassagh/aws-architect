...
export const SearchBar = forwardRef<SearchBarHandle, SearchBarProps>(function SearchBar({ onSearch }, ref) {
  ...
  return (
    <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1 rounded-lg bg-white/90 backdrop-blur-sm border border-slate-200 shadow-sm overflow-hidden">
