  ...
  return (
    ...
    >
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-end px-6 py-4">
        <div className="flex items-center gap-1">
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-3.5 py-2 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-slate-100 dark:hover:bg-white/10 transition-colors"
          >
      ...
      <div className="relative z-10 text-center mb-5">
        ...
        <p className="mt-3 text-base sm:text-lg text-slate-500 dark:text-slate-400 max-w-md mx-auto leading-relaxed">
      ...
      <div className="relative z-10 w-full max-w-5xl mb-4 flex items-center gap-5">
        <div className="hidden lg:block w-64 shrink-0">
          <div className="rounded-lg overflow-hidden shadow-md ring-1 ring-slate-200 dark:ring-white/10 opacity-75 hover:opacity-100 transition-opacity h-40">
            <img src="/preview-graph.png" alt="Dark mode preview" className="w-full h-full object-cover object-top" loading="lazy" />
          </div>
          <p className="text-[10px] text-slate-400 dark:text-slate-500 text-center mt-1.5">Dark mode</p>
        </div>
        ...
        <div className="hidden lg:block w-64 shrink-0">
          <div className="rounded-lg overflow-hidden shadow-md ring-1 ring-slate-200 dark:ring-white/10 opacity-75 hover:opacity-100 transition-opacity h-40">
            <img src="/preview-light.png" alt="Light mode preview" className="w-full h-full object-cover object-top" loading="lazy" />
          </div>
          <p className="text-[10px] text-slate-400 dark:text-slate-500 text-center mt-1.5">Light mode</p>
        </div>
      </div>
